...
class Reconciliator:
    ...
    def _process_duplicates(self, df: pl.DataFrame, col_name: str):
        ...
        if duplicates_df.select(pl.len()).item():
            ...
            # To recreate original external dataframe imported with duplicated columns to allow duplicate processing
            add_cols_exp = []
            ...
            self.b_to_a_nmt = pl.concat([self.b_to_a_nmt, no_conciliated_dup_df])
    ...
    def save_to_file(self):
        self.a_to_b_mt.write_csv("./results/a_to_b_mt.csv")
        self.a_to_b_nmt.write_csv("./results/a_to_b_nmt.csv")
        self.b_to_a_nmt.write_csv("./results/b_to_a_nmt.csv")
    ...
    def match_records(self):
        ...
        self.a_to_b_mt = pl.concat([self.a_to_b_mt, clean_join_df])
    ...
    def not_match_records(self):
        ...
        self.a_to_b_nmt = pl.concat([self.a_to_b_nmt, join_df])
